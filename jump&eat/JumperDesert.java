...
public class JumperDesert extends Mover implements Subject
{
    private int speed = 7;
    ...
    public boolean onGround()
    {
        ...
        Actor ground = getOneObjectAtOffset(0, getImage().getHeight()/2, GroundDesert.class);
        if(ground == null)
        {
            jumping = true;
            return false;
