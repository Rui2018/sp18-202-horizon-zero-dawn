...
public class DesertWorld extends World
{
    ...
    {
        addObject(new GroundDesert(0), 20, 80);
        addObject(new GroundDesert(0), 100, 450);
        addObject(new GroundDesert(0), 450, 450);
        addObject(new GroundDesert(0), 800, 450);
       
        addObject(new GroundDesert(1), 550, 400);
        addObject(new GroundDesert(1), 800, 350);
        addObject(new GroundDesert(-2), 200, 300);
        
        addObject(new GroundDesert(0), 420, 250);
        addObject(new GroundDesert(2), 500, 200);
        addObject(new GroundDesert(-1), 700, 150);
