 ...
 */
public class JumperForest extends Mover implements Subject
{
    private int speed = 5;
    ...
    /**
     * Act - do whatever the JumperForest wants to do. This method is called whenever
    ...
    public boolean onGround(){
        ...
        Actor under = getOneObjectAtOffset(0, getImage().getHeight() / 2, GroundForest.class);
        //return under != null;
        if(under == null){
            jumping = true;
            return false;
